...
import foto1SAEBE1 from "../assets/foto1SAEBE1.JPG";
import foto2SAEBE1 from "../assets/foto2SAEBE1.JPG";
import foto3SAEBE1 from "../assets/foto3SAEBE1.JPG";

import foto1SAEBE2 from "../assets/foto1SAEBE2.JPG";
import foto2SAEBE2 from "../assets/foto2SAEBE2.JPG";
    ...
    () => [
      {
        ...
        data: "2024",
        descricao: "Um dia dedicado a palestras e workshops, promovendo a troca de conhecimento, inovação e integração entre estudantes e profissionais da engenharia biomédica.",
      ...
      },
      {
        ...
        titulo: "FOOD & SCIENCE",
        data: "2024",
        descricao: "Um encontro descontraído entre professores e alunos, com compartilhamento de experiências sobre graduação, mestrado e doutorado, acompanhado de comida e boas conversas.",
        imagens: [foto2FOOD1],
      },
      {
        id: 3,
        ...
        data: "2024",
        descricao: "Atividade voltada à valorização das contribuições femininas na ciência, com a produção de cartazes sobre descobertas e trajetórias.",
      ...
      },
      {
        ...
        data: "2024",
        descricao: "Edição com participação de Marta Puerto, do time de inovação do Einstein, e da startup Biologix, promovendo uma conversa sobre inovação, empreendedorismo e ciência.",
      ...
      },
      {
        ...
        data: "2024",
        descricao: "Momento de diálogo e troca de experiências sobre desafios, trajetórias e vivências de mulheres na engenharia, guiado pelas professoras Dra. Paula Antunes e Dra. Maria Isabel Orselli.",
      ...
      },
      {
        ...
        data: "2025",
        descricao: "Encontro com representantes da Amazon, da diretoria do Hospital Israelita Albert Einstein e da indústria farmacêutica, promovendo diálogo sobre liderança, carreira e impacto.",
      ...
      },
      {
        ...
        titulo: "2º SAEBE",
        data: "2025",
        descricao: "Um dia intenso de palestras e workshops, conectando estudantes à prática e à inovação em engenharia biomédica.",
